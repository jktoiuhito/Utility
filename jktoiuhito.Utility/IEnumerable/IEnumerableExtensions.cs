...
namespace jktoiuhito.Utility.IEnumerable
{
    ...
    {
        const string EmptyEnumerable = 
            "IEnumerable cannot be empty";

        /// <summary>
        ///     Return the input <see cref="IEnumerable{T}"/> if it is not null
        ///     and not empty. Otherwise throws an exception.
        /// </summary>
        /// <typeparam name="T">
            ...
            this IEnumerable<T> enumerable, string localName = null)
        {
            ...
            throw new ArgumentException(EmptyEnumerable);
        }
    }
}
